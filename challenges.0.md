...
- Optional: *Ubuntu VM for building and tagging* - we need a machine to work with Docker. If your local machine isn't set up for Docker, just start up an instance in Azure - use the Ubunut 16.04 LTS
